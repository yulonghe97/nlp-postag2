...
------------------------------------------------------
To run this program, type in console $node postag.js
------------------------------------------------------
...
3. Calculate proability of the word within that tag and store that in the hashtable.
...
5. Do the same process as above, calculate the proability and put that into a hashtable.
